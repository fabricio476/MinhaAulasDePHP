...
valor da gratificação que esse funcionário receberá:
  ...
  <form action="exp3.php" method="post">
  	...
  	<p>
  		<button type="submit" name="enviarexp3">Enviar</button>
  	</p>
  ...
  if (isset($_POST['salario'])) {
    ...
    //se salario > 1500
     ...
     }else{ //qualquer valor abaixo de 1500 para o salario
  ...
  } // if principal verifica se form foi submetido
